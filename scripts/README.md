...
Some Python-bash pairs derive the same sandbox name and will reach the same
running sandbox rather than creating a separate one. Run `sbx ls` to see
what is running before switching between the two interfaces.
